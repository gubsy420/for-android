        ...
        AndroidView(
            factory = { context ->
                WebView(context).apply {
                    ...
                    // Fork change: Discover is an official-instance service; pin it
                    // to the official domain regardless of configured instance
                    loadUrl("$STOAT_OFFICIAL_INVITES/discover/servers?embedded=true")
